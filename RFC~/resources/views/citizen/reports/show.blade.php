    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1" style="font-weight: 700; color: var(--text);">
                <i class="fas fa-file-alt me-2" style="color: var(--primary);"></i>Detail Laporan
            </h2>
            <p class="text-muted mb-0">Informasi lengkap laporan Anda</p>
        </div>
        <a href="{{ route('citizen.reports.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h5 class="mb-0" style="font-weight: 600;">Informasi Laporan</h5>
                </div>
                <div class="card-body">
                    <!-- Ticket Number Badge -->
