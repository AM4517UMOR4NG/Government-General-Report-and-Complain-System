...
@section('title', 'Reports - Administration')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('administration.dashboard') }}" class="btn btn-secondary btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('administration.reports.download', $report->id) }}" class="btn btn-success btn-sm">
